...
public class composDemo extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_compos);
        //初始化各面板
        findView();
        initSurfaceView();
                ...
                case R.id.cameraBtn:
                    ...
                    if(isRecording)
                    {
                        try {
                            ...
                            // 创建保存录制视频的视频文件
                            videoFile = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/videoCompos/testVideo.mp4");
                            // 创建MediaPlayer对象
